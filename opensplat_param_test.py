    ...
    def define_test_cases(self) -> List[TestCase]:
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"downscale-factor": "1", "num-iters": "20000"}
            ),
            TestCase(
                name="scale_2",
                description="1/2 分辨率（平衡）",
                params={"downscale-factor": "2", "num-iters": "20000"}
            ),
            TestCase(
                name="scale_4",
                description="1/4 分辨率（快速预览）",
                params={"downscale-factor": "4", "num-iters": "20000"}
            ),
        ])
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"sh-degree": "1", "num-iters": "15000"}
            ),
            TestCase(
                name="sh_2",
                description="SH Degree 2（中等光照）",
                params={"sh-degree": "2", "num-iters": "15000"}
            ),
            TestCase(
                name="sh_3",
                description="SH Degree 3（默认，完整光照）",
                params={"sh-degree": "3", "num-iters": "15000"}
            ),
        ])
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"ssim-weight": "0", "num-iters": "15000"}
            ),
            TestCase(
                name="ssim_0.2",
                description="SSIM权重0.2（默认平衡）",
                params={"ssim-weight": "0.2", "num-iters": "15000"}
            ),
            TestCase(
                name="ssim_0.5",
                description="SSIM权重0.5（更强调结构相似性）",
                params={"ssim-weight": "0.5", "num-iters": "15000"}
            ),
        ])
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"refine-every": "50", "num-iters": "15000"}
            ),
            TestCase(
                name="refine_100",
                description="每100步细化（默认）",
                params={"refine-every": "100", "num-iters": "15000"}
            ),
            TestCase(
                name="refine_200",
                description="每200步细化（更稀疏，更少高斯）",
                params={"refine-every": "200", "num-iters": "15000"}
            ),
        ])
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"densify-grad-thresh": "0.0001", "num-iters": "15000"}
            ),
            TestCase(
                name="grad_0.0002",
                description="梯度阈值0.0002（默认）",
                params={"densify-grad-thresh": "0.0002", "num-iters": "15000"}
            ),
            TestCase(
                name="grad_0.0004",
                description="梯度阈值0.0004（较不敏感，较少分裂）",
                params={"densify-grad-thresh": "0.0004", "num-iters": "15000"}
            ),
        ])
        ...
        test_cases.extend([
            TestCase(
                ...
                params={"densify-size-thresh": "0.005", "num-iters": "15000"}
            ),
            TestCase(
                name="size_0.01",
                description="尺寸阈值0.01（默认）",
                params={"densify-size-thresh": "0.01", "num-iters": "15000"}
            ),
            TestCase(
                name="size_0.02",
                description="尺寸阈值0.02（更多分裂）",
                params={"densify-size-thresh": "0.02", "num-iters": "15000"}
            ),
        ])
